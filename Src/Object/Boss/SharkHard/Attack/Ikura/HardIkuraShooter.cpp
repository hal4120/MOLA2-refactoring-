...
HardIkuraShooter::~HardIkuraShooter()
{
}

void HardIkuraShooter::Load(void)
{
...
void HardIkuraShooter::Update(void)
{
	for (auto& ikura : ikuras_) { ikura->Update(); }
}

void HardIkuraShooter::Draw(void)
{
...
void HardIkuraShooter::Shot(void)
{
	if (!shot_) { return; }
	...
	position.x -= SharkHard::SIZE_X / 2.0f;
